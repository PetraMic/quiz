...
public class QuizMain {
    public static void main(String[] args) {
        Quiz quiz = new Quiz();
        Question question1 = new Question("In the pre-Columbian period, which animal was a symbol of strength and power?", QuestionType.SINGLE);
        ...
        Question question2 = new Question("What is the name of the largest technology company in south korea?", QuestionType.SINGLE);
        ...
        Question question3 = new Question("How many times a day does a person inhale on average?", QuestionType.SINGLE);
        ...
        Question question4 = new Question("What is Barbie's full name?", QuestionType.SINGLE);
        ...
        Question question5 = new Question("What is the longest river in the world?", QuestionType.SINGLE);
        ...
        Question question6 = new Question("Which cities are located in Finland?", QuestionType.MULTIPLE);
        ...
        Question question7 = new Question("Which of these famous people were blind?", QuestionType.MULTIPLE);
