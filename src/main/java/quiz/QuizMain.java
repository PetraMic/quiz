...
public class QuizMain {
    public static void main(String[] args) {
        Quiz quiz = new Quiz();
        Question question1 = new Question("In the pre-Columbian period, which animal was a symbol of strength and power? Question with 1 correct answer.", QuestionType.SINGLE);
        ...
        Question question2 = new Question("What is the name of the largest technology company in south korea? Question with 1 correct answer.", QuestionType.SINGLE);
        ...
        Question question3 = new Question("How many times a day does a person inhale on average? Question with 1 correct answer.", QuestionType.SINGLE);
        ...
        Question question4 = new Question("What is Barbie's full name? Question with 1 correct answer.", QuestionType.SINGLE);
        ...
        Question question5 = new Question("What is the longest river in the world? Question with 1 correct answer.", QuestionType.SINGLE);
        ...
        Question question6 = new Question("Which cities are located in Finland? Question with multiple correct answers.", QuestionType.MULTIPLE);
        ...
        Question question7 = new Question("Which of these famous people were blind? Question with multiple correct answer.", QuestionType.MULTIPLE);
